...
int main(int argc, char **argv) {
  ...
  char *create_request = call_request(
      ...
      g_variant_new("(@a{sv})",
                    options_with_tokens(
                        "madobe_m2_portal_screencast_client_proof_create",
                        "madobe_m2_portal_screencast_client_proof_session")),
      &error);
  ...
  char *select_request =
      call_request(&probe, "SelectSources",
                   g_variant_new("(o@a{sv})", session_handle,
                                 select_options(
                                     "madobe_m2_portal_screencast_client_proof_select")),
                   &error);
  ...
  char *start_request =
      call_request(&probe, "Start",
                   g_variant_new("(os@a{sv})", session_handle, "",
                                 start_options(
                                     "madobe_m2_portal_screencast_client_proof_start")),
                   &error);
